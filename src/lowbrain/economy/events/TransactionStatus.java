...
public enum TransactionStatus {
    ...
    BANK_BALANCE_MAXED, // bank can no longer sell because it has reach is maximum bank account amount
    BANK_BALANCE_LOW, // bank can no longer buy because it has reach is minimum bank account amount
